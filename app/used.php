                ...
                <section class="content">
                        <div class="col-md-8">
                            <div class="box" style="padding: 10px;">
                                ...
                                <form role="form" action="used.php" method="post">
...
<div class="col-md-4" style="float: right;">
    <div class="box" style="padding: 10px;">
        ...
        <h4>Amount Used</h4>
        <p>Here is where you put in the amount you just used of the item. We will automaticly take it away from the amount you already have.</p><br/>
    </div>
</div>
                </section><!-- /.content -->
            </aside><!-- /.right-side -->
